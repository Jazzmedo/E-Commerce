...
<body>
    ...
    <form id="pro-details" class="section-p1" method="post">
        ...
        <div class="single-pro-details">
            ...
            <input type="hidden" name="product_image" value="watch7.jpg">
            <input type="hidden" name="product_name" value="Rolex Sea-Dweller">
            <input type="hidden" name="product_price" value="40000.00">
            <input id="normo"
