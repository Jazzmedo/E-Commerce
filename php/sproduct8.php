...
<head>
    ...
    <title>Rolex Archetypal Dive Watch</title>
...
<body>
    ...
    <form id="pro-details" class="section-p1" method="post">
        ...
        <div class="single-pro-image">
            <img src="../img/watch9.jpg" alt="" width="100%" id="main-img">
        </div>
        </div>
        <div class="single-pro-details">
            <h6>Home/ Watches</h6>
            <h4>Rolex Archetypal Dive Watch</h4>
            <h3>$ 16500.00</h3>
            <br>
            <input type="number" min="1" name="product_quantity" value="1">
            <input type="hidden" name="product_image" value="watch9.jpg">
            <input type="hidden" name="product_name" value="Rolex Archetypal Dive Watch">
            <input type="hidden" name="product_price" value="16500.00">
            <input id="normo"
