...
<body>
    ...
    <form id="pro-details" class="section-p1" method="post">
        ...
        <div class="single-pro-image">
            <img src="../img/watch4.jpg" alt="" width="100%" id="main-img">
        </div>
        </div>
        <div class="single-pro-details">
            ...
            <input type="hidden" name="product_image" value="watch4.jpg">
            <input type="hidden" name="product_name" value="Rolex GMT-Master II">
            <input type="hidden" name="product_price" value="28500.00">
            <input id="normo"
