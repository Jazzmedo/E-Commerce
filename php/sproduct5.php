...
<head>
    ...
    <title>Rolex Tudor Heritage Black</title>
...
<body>
    ...
    <form id="pro-details" class="section-p1" method="post">
        ...
        <div class="single-pro-image">
            <img src="../img/watch5.jpg" alt="" width="100%" id="main-img">
        </div>
        </div>
        <div class="single-pro-details">
            ...
            <input type="hidden" name="product_image" value="watch5.jpg">
            <input type="hidden" name="product_name" value="Rolex Tudor Heritage Black">
            <input type="hidden" name="product_price" value="13400.00">
            <input id="normo"
