...
<body>
    ...
    <form id="pro-details" class="section-p1" method="post">
        ...
        <div class="single-pro-image">
            <img src="../img/watch.jpg" alt="" width="100%" id="main-img">
        </div>
        </div>
        <div class="single-pro-details">
            ...
            <input type="hidden" name="product_image" value="watch.jpg">
            <input type="hidden" name="product_name" value="Rolex Oyster Perpetual">
            <input type="hidden" name="product_price" value="25000.00">
            <input id="normo"
